...
main_download() {
    ...
    case $file in
    sysbench)
        local url="https://gh-proxy.org/https://github.com/akopytov/sysbench/archive/1.0.20.zip"
        ...
        ;;
    UnlockTests)
        local url="https://gh-proxy.org/https://github.com/oneclickvirt/UnlockTests/releases/download/output/${UnlockTests_FILE}"
    ...
    nexttrace)
        ...
        local url="https://gh-proxy.org/https://github.com/nxtrace/Ntrace-core/releases/download/${NEXTTRACE_VERSION}/${NEXTTRACE_FILE}"
        ...
        ;;
    backtrace)
        local url="https://gh-proxy.org/https://github.com/oneclickvirt/backtrace/releases/download/output/$BACKTRACE_FILE"
        local output="$TEMP_DIR/backtrace"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    gostun)
        local url="https://gh-proxy.org/https://github.com/oneclickvirt/gostun/releases/download/output/$GOSTUN_FILE"
        local output="$TEMP_DIR/gostun"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    securityCheck)
        local url="https://gh-proxy.org/https://github.com/oneclickvirt/securityCheck/releases/download/output/$SecurityCheck_FILE"
        local output="$TEMP_DIR/securityCheck"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    portchecker)
        local url="https://gh-proxy.org/https://github.com/oneclickvirt/portchecker/releases/download/output/$PortChecker_FILE"
    ...
    yabs)
        ...
        ;;
    ecsspeed_ping)
        local url="https://gh-proxy.org/https://raw.githubusercontent.com/spiritLHLS/ecsspeed/main/script/ecsspeed-ping.sh"
